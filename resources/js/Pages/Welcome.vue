    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-10 w-auto text-gray-700 md:h-16 md:w-auto">
                ...
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700 md:h-14 md:w-14 mt-2 md:mt-0">
                ...
                <svg viewBox=".15 .13 799.7 479.69" xmlns="http://www.w3.org/2000/svg" class="h-9 w-auto text-gray-700 md:h-14 md:w-auto">
            ...
            <div class="mx-auto mt-6 sm:items-center sm:justify-between">
                <div class="box-border md:box-content p-0">
                    <Link :href="route('places.index')" class="text-xl text-gray-700 text-center underline">
