    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <svg viewBox="0 0 256 298" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" class="h-4 w-4 text-gray-700 ">
                ...
                <svg viewBox="0 0 256 221" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" class="h-16 w-auto text-gray-700 sm:h-20">
